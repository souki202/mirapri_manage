...
class EquipmentTest < ApplicationSystemTestCase
  ...
  test "creating a Equipment" do
    ...
    fill_in "Item level", with: @equipment.item_level
    fill_in "Level", with: @equipment.level
    fill_in "Name", with: @equipment.name
    fill_in "Place", with: @equipment.place
    fill_in "Race", with: @equipment.race
    fill_in "Sex", with: @equipment.sex
